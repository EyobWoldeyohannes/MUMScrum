	...
	<section>
		<div class="jumbotron">
			<div class="container">
				...
				<h1>Our MUMScrum Sprints</h1>
				<!-- <p>All of the contributors to our great proje!!!</p> -->
			</div>
			
			
			<a href="<c:url value="/sprints/add" />"
				class="btn btn-danger btn-mini pull-right">Add a new Sprint</a> <a
				href="<c:url value="/employees/employee/6" />"
				class="btn btn-danger btn-mini pull-right">Find Sprint BY Id</a>
		</div>
	...
	<section class="container">
		<div class="row">
			<c:forEach items="${sprints}" var="sprint">
				<div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
					<div class="thumbnail">
						<div class="caption">
							...
							<h3>SprintId - ${sprint.sprintId}</h3>
							<h3>Start Date - ${sprint.startDate}</h3>
							<h3>Due Date - ${sprint.dueDate}</h3>
				...
				<a href="<c:url value="/sprints/edit/${sprint.sprintId }" />"
				class="btn btn-danger btn-mini ">Edit</a> <a
				href="<c:url value="/sprints/sprint/${sprint.sprintId }" />"
				class="btn btn-danger btn-mini ">Details</a>
					
				<a href="<c:url value="/sprints/delete/${sprint.sprintId }" />"
